...
async function findDocumentFiles(dir, extensions) {
...
async function runDocTest(docFile, options = {}) {
...
async function runDocTests(input, extensions, options = {}) {
