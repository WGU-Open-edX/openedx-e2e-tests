...
const element_highlighter_1 = require("../../utils/element-highlighter");
/**
 ...
 */
async function captureViolationScreenshots(page, results, screenshotDir) {
 ...
 */
function addScreenshotsToReport(reportHtml, screenshotMap) {
  ...
  `;
    ...
    reportHtmlCopy = reportHtmlCopy.replace(/<th style="width: 49%">Issue Description<\/th>\s*<th style="width: 49%">\s*To solve this violation, you need to\.\.\.\s*<\/th>/g, `<th style="width: 30%">Issue Description</th>
                                    <th style="width: 30%">
 ...
 */
async function saveReport(page, results, reportPath) {
 ...
 */
function generateReportPath(testInfo, options) {
 ...
 */
function updateMainIndex(baseDir, reportPath, results, pageUrl, testInfo) {
