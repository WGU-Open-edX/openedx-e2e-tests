...
if (require.main === module) {
  ...
  if (!input) {
    console.log('Usage: node run-rst-test.js <rst-file-or-directory> [options]');
    console.log('Options:');
    ...
    console.log('  node run-rst-test.js tests/testdoc/login.rst');
    console.log('  node run-rst-test.js tests/testdoc/ --headed --project=chromium');
    process.exit(1);
  }
