...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Password' }).fill('Win7vbnet');
  ...
  await page.getByRole('textbox', { name: 'Course name' }).fill('New Course5');
  ...
  await page.getByRole('textbox', { name: 'Course number' }).fill('5');
