  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('user can add a Unit to a course', async ({ page }, testInfo) => {
        ...
        /*  NOTE: 
            ...
            blockId, so after some digginf I though in refresh the page and then edit the element that has the blockId making the redirect successfully
            being able to create unit
        */ 
       await page.reload()
       await page.waitForLoadState('networkidle');
