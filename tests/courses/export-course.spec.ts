...
test.describe('Export Course Tests', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('user can export a course', async ({ page }, testInfo) => {
        ...
        // const course = 'a.card-item-title:text("Automated TestCourse")';
        // const selector = '//div[contains(@class,"card-item")]//a[normalize-space()="Automated TestCourse"]';


        await testDoc.click({
           // selector: `${xpathFirst}//div[contains(concat(" ", normalize-space(@class), " "), " card-item ")]`,
